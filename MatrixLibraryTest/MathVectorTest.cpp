...
namespace MATH_VECTOR_TESTS{
	...
	TEST(VectorDotProductTests, BASIC_DOT_PRODUCT_WORKS_AS_INTENDED)
	{
		MathVector allPos = { 1,2,3, 4 };
		MathVector allNeg = { -1, -5, -2.5, -3.2 };
		MathVector mix({ -4.3, 0, 2.4, 9.1 });

		EXPECT_NEAR(dotProduct(allPos, allPos), 30, 0.001);
		EXPECT_NEAR(allNeg.dotProduct(allNeg), 42.49, 0.001);
